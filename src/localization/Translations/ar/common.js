export default {
  ...
  You_find_all_the_hotels_in_our_database_you_can_search_for_a_hotel_by_name_or_by_city:"ستجد جميع الفنادق في قاعدة البيانات الخاصة بنا ويمكنك البحث عن فندق بالاسم أو حسب المدينة",
};
